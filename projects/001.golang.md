...
### <span id="head9">3.1.HTTP RPC</span>
可被调用的函数样式：
...
### <span id="head10">3.2.TCP RPC</span>
服务端示例：
```
package main
...
### <span id="head11">3.3.JSON RPC</span>
...
## <span id="head15"> 6.WEB相关</span>
略

## <span id="head16"> 7.反射</span>
go的反射库`reflect`
...
## <span id="head17"> 8.泛型</span>

## <span id="head18">9.lexer &parser</span>
